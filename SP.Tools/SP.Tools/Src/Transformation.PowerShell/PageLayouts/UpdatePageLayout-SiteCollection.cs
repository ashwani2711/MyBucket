...
namespace Transformation.PowerShell.PageLayouts
{
    ...
    public class UpdatePageLayout_SiteCollection : TrasnformationPowerShellCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            obj.ChangePageLayoutForPagesUsingOldPageLayoutInSiteCollection(InputFolder, SiteCollectionUrl, OldPageLayoutUrl, NewPageLayoutUrl, NewPageLayoutDescription, SharePointOnline_OR_OnPremise, UserName, Password, Domain);
        }
    }    
}
