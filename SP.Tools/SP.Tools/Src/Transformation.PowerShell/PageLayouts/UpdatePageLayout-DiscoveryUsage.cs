...
namespace Transformation.PowerShell.PageLayouts
{
    ...
    public class UpdatePageLayout_DiscoveryUsage : TrasnformationPowerShellCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            obj.ChangePageLayoutForDiscoveryOutPut(InputFolder, OldPageLayoutUrl, NewPageLayoutUrl, NewPageLayoutDescription, SharePointOnline_OR_OnPremise, UserName, Password, Domain);
        }
    }
}
