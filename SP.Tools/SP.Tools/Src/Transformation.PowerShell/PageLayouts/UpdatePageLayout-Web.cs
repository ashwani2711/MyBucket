...
namespace Transformation.PowerShell.PageLayouts
{
    ...
    public class UpdatePageLayout_Web : TrasnformationPowerShellCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            obj.ChangePageLayoutForPagesUsingOldPageLayoutInWeb(InputFolder, WebUrl, NewPageLayoutUrl, OldPageLayoutUrl, NewPageLayoutDescription, "", SharePointOnline_OR_OnPremise, UserName, Password, Domain);
