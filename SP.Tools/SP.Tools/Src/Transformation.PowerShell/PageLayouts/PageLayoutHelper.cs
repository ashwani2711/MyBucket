...
namespace Transformation.PowerShell.PageLayouts
{
    public class PageLayoutHelper
    {
        ...
        /// <param name="PageLayoutURL"></param>
        /// <returns></returns>
        ...
        /// </summary>
        /// <param name="DiscoveryUsage_OutPutFolder"></param>
        /// <param name="oldPageLayoutUrl"></param>
        /// <param name="newPageLayoutUrl"></param>
        /// <param name="newPageLayoutDescription"></param>
        /// <param name="SharePointOnline_OR_OnPremise"></param>
        /// <param name="UserName"></param>
        /// <param name="Password"></param>
        /// <param name="Domain"></param>
        public void ChangePageLayoutForDiscoveryOutPut(string DiscoveryUsage_OutPutFolder, string oldPageLayoutUrl = "N/A", string newPageLayoutUrl = "N/A", string newPageLayoutDescription = "N/A", string SharePointOnline_OR_OnPremise = "OP", string UserName = "N/A", string Password = "N/A", string Domain = "N/A")
        {
            ...
            try
            {
                ...
                ReadPagesFromDiscoveryUsageFiles(DiscoveryUsage_OutPutFolder, out objPageInput);
        ...
        /// </summary>
        /// <param name="outPutFolder"></param>
        /// <param name="objPLInput"></param>
        private void ReadPagesFromDiscoveryUsageFiles(string outPutFolder, out IEnumerable<PageLayoutInput> objPLInput)
        {
            ...
            try
            {
                if (objPLInput.Any())
                {
                    ...
                    foreach (PageLayoutInput objInput in objPLInput)
                    {
                        ...
                        if (oldPageLayoutUrl.ToLower().Trim() != "all" && oldPageLayoutUrl.ToLower().Trim() != "")
                        {
                            List<PageLayoutBase> objbase = ChangePageLayoutForPagesUsingOldPageLayoutInWeb(DiscoveryUsage_OutPutFolder, objInput.WebUrl, newPageLayoutUrl, oldPageLayoutUrl.ToLower().Trim(), newPageLayoutDescription, "DiscoveryUsage", SharePointOnline_OR_OnPremise, UserName, Password, Domain);
                        ...
                        {
                            List<PageLayoutBase> objbase = ChangePageLayoutForPagesUsingOldPageLayoutInWeb(DiscoveryUsage_OutPutFolder, objInput.WebUrl, newPageLayoutUrl, objInput.PageLayout_ServerRelativeUrl, newPageLayoutDescription, "DiscoveryUsage", SharePointOnline_OR_OnPremise, UserName, Password, Domain);
        ...
        public void ChangePageLayoutForPagesUsingOldPageLayoutInSiteCollection(string outPutFolder, string SiteCollectionUrl = "N/A", string oldPageLayoutUrl = "N/A", string newPageLayoutUrl = "N/A", string newPageLayoutDescription = "N/A", string SharePointOnline_OR_OnPremise = "OP", string UserName = "N/A", string Password = "N/A", string Domain = "N/A")
        {
            ...
            try
            {
                ...
                if (clientContext != null)
                {
                    ...
                    //Root Web
                    objPLBase = ChangePageLayoutForPagesUsingOldPageLayoutInWeb(outPutFolder, rootWeb.Url.ToString(),newPageLayoutUrl, oldPageLayoutUrl, newPageLayoutDescription,"SiteCollection", SharePointOnline_OR_OnPremise, UserName, Password, Domain);
                    if (objPLBase != null)
                    {
                    ...
                    foreach (Web webSite in webCollection)
                    {
                        ...
                        {
                            //Web
                            objPLBase = ChangePageLayoutForPagesUsingOldPageLayoutInWeb(outPutFolder, webSite.Url,newPageLayoutUrl, oldPageLayoutUrl, newPageLayoutDescription,"SiteCollection", SharePointOnline_OR_OnPremise, UserName, Password, Domain);
        ...
        public List<PageLayoutBase> ChangePageLayoutForPagesUsingOldPageLayoutInWeb(string outPutFolder, string WebUrl, string newPageLayoutUrl, string oldPageLayoutUrl = "N/A", string newPageLayoutDescription = "N/A", string ActionType = "", string SharePointOnline_OR_OnPremise = "N/A", string UserName = "N/A", string Password = "N/A", string Domain = "N/A")
        {
            ...
            try
            {
                ...
                if (clientContext != null)
                {
                    ...
                    if (oldPageLayoutUrl.Trim() != "" && oldPageLayoutUrl.Trim().ToLower() != "all")
                    {
                    ...
                    if (_IsPublishingWeb)
                    {
                        ...
                        if (Check_PageLayoutExistsINGallery(clientContext, _newPageLayoutUrl))
                        {
                            ...
                            foreach (ListItem item in items)
                            {
                                ...
                                try
                                {
                                    if (oldPageLayoutUrl.Trim().ToLower() != "" && oldPageLayoutUrl.Trim().ToLower() != "all")
                                    {
