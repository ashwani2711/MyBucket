...
namespace Transformation.PowerShell.WebPart
{
    ...
    public class ReplaceWebPartByUsageCSV : TrasnformationPowerShellCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            webPartTransformationHelper.ReplaceWebPart_UsingCSV(SourceWebPartType, TargetWebPartFileName, TargetWebPartXmlDir, WebPartUsageFileName,OutPutDirectory, SharePointOnline_OR_OnPremise, UserName, Password, Domain,"CSV");
        }
    }
}
