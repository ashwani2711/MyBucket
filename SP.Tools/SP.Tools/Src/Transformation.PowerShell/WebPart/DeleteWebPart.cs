...
namespace Transformation.PowerShell.WebPart
{
    ...
    public class DeleteWebPart : TrasnformationPowerShellCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            webPartTransformationHelper.DeleteWebPart(WebUrl, ServerRelativePageUrl, new Guid(WebPartID), OutPutDirectory, SharePointOnline_OR_OnPremise, UserName, Password, Domain, "web");
        }
    }
}
