...
namespace Transformation.PowerShell.MasterPage
{
    ...
    public class UpdateMasterPageWebLevel : TrasnformationPowerShellCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            objMasterHelper.ChangeMasterPageForWeb(InputFolder, WebUrl, New_MasterPageURL, Old_MasterPageURL, CustomMasterUrlStatus, MasterUrlStatus,"",SharePointOnline_OR_OnPremise,UserName,Password,Domain);
        }
    }
}
