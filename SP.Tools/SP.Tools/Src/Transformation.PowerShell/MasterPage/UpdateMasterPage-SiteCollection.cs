...
namespace Transformation.PowerShell.MasterPage
{
    ...
    public class UpdateMasterPageSiteCollectionLevel : TrasnformationPowerShellCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            objMasterHelper.ChangeMasterPageForSiteCollection(InputFolder,SiteCollectionUrl, New_MasterPageURL, Old_MasterPageURL,CustomMasterUrlStatus,MasterUrlStatus,SharePointOnline_OR_OnPremise,UserName,Password,Domain);  
        }
    }
